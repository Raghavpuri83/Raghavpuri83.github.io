                ...
                <div class="container">
                    <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
                        ...
                        <form  action="signup_script.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Password" pattern=".{6,}" name="password" aria-describedby="passwordHint" required = "true">
                                <h6 style="color: rgba(0,0,0,.6);"><span class="glyphicon glyphicon glyphicon-info-sign"></span> Password must be at least 6 characters long.</h6>
